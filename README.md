...
## 에뮬레이터 실행
>> cd C:\Users\parkJs\AppData\Local\Android\Sdk\emulator
...
2. java설치, python설치, node 설치, choco 설치,
...
5. 	설치완료 시 실행명렁어
      npm run android (최종 실행 명령어이며, 자동으로 npm start 창이 뜬다.)

6. 실행에러 시 확인 명령어
   react-native doctor

7. 5번 실행 후 could not connect to development server 에러시
   npm start
   a
